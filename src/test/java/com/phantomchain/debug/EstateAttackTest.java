...
public class EstateAttackTest {
    ...
    static Ledger genesis(int n) throws Exception {
        ...
        Ledger g = new Ledger(); g.genesisEcon("pc-estate", alloc, vals, stk, idn, ver, vp, bc, 1700000000000L);
        g.committeeSize = 0; g.blockReward = 0;   // no emission -> exact balance assertions (estate transfer)
        return g;
    }
